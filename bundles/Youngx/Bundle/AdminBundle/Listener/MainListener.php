...
class MainListener implements Registration
{
    ...
    {
        return array(
            'kernel.access@collection:Admin' => 'checkAccessForAdminRole',
            'kernel.access.deny#user-login@collection:Admin' => 'redirectAdminResponse',
            'kernel.access.deny@collection:Admin' => 'redirectAdminLoginResponse',
